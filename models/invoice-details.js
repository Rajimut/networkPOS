...
var invoice_db = invoice_mongoose.createConnection('localhost:27020/invoice'); //connect to invoice DB
...
module.exports = invoice_db.model('InvoiceDetails', invoicedetailsSchema);